...
* {ActiveWarehouse/ETL presentation (including Cupcakes Inc demo) - Singapore Ruby Brigade Jan-2010}[http://]
...
* Clone the github repositories
	...
	$ git://github.com/tardate/cupcakesinc.git
	$ git://github.com/tardate/cupcakesinc-dashboard.git
